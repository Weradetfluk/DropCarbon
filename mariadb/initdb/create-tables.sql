...
--
ALTER TABLE `dcs_event`
  MODIFY `eve_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีของกิจกรรม', AUTO_INCREMENT=4;
...
--
ALTER TABLE `dcs_promotions`
  MODIFY `pro_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีของโปรโมชัน หรือของรางวัล';
