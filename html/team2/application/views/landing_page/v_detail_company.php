        ...
        <div class="col-12">
            <div class="container">
                <?php if (count($image) == 1) { ?>
                    <img src="<?php echo base_url() . 'image_company/' . $image[0]->com_img_path; ?>" style="object-fit: cover; width: 500px; height: 300px;" id="img_01">
                <?php } elseif (count($image) == 2) { ?>
                    <div class="row">
                        <div class="col">
                            <img src="<?php echo base_url() . 'image_company/' . $image[0]->com_img_path; ?>" style="object-fit: cover;  height: 300px;" id="img_01">
                        </div>
                        <div class="col">
                            <img src="<?php echo base_url() . 'image_company/' . $image[1]->com_img_path; ?>" style="object-fit: cover; height: 300px;" id="img_02">
                        </div>
                    </div>
                <?php } else { ?>
                    <div class="responsive">
                        <?php for ($i = 0; $i < count($image); $i++) { ?>
                            <div class="">
                                <img src="<?php echo base_url() . 'image_company/' . $image[$i]->com_img_path; ?>" style="object-fit: cover; width: 100%; height: 300px;" id=" <?php 'img' . $i  ?> ">
                            </div>
                        <?php } ?>
                    </div>
                <?php } ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-5">
                ...
                <hr width="100%" size="10" color="#cccccc">
                <p style="font-size: 18px; text-indent: 50px;">กิจกรรมนี้จัดอยู่ในประเภท: <?php echo $company->com_cat_name; ?></p>
            </div>
            <div class="col-2"></div>
        </div>
    </div>
