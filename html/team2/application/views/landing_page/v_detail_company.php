                    ...
                    <div class="card card-h-100" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);">
                        <div class="card-horizontal">
                            <div class="col-6" style="margin: 20px auto;">
                                <img src="<?php echo base_url() . 'image_company/' . $image->com_img_path; ?>" class="card-img-top" alt="...">
                            </div>
                            <!-- รูป -->
            ...
            <div class="row" style="padding-top: 5%;">
                <div class="col">
                    ...
                    <div class="col" style="padding-left: 2%">
                        <div style="padding-left: 2%;padding-top: 2%;padding-bottom: 2%"><?php echo $company->com_description ?>
                        </div>
                    </div>
                    <!-- รายละเอียด -->
