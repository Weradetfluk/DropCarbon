...
<div class="container py-5">
    ...
    <!-- ชื่อกิจกรรม -->
    <div class="row">
        <?php $share_location = "https://developers.facebook.com/docs/plugins/share-button/"; ?>
        <div class="col fb-share-button" data-href="<?= $share_location ?>" data-layout="button" data-size="large">
