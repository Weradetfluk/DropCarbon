         ...
         <div class="container py-5">
             ...
             <div class="row">
                 <div class="col text-center">
                     <a href="<?php echo base_url() . 'Tourist/Checkin_event/Checkin_event/show_page_checkin'  ?>"
...
function get_location() {
    navigator.geolocation.getCurrentPosition((position) => {
        ...
        <?php
                if (isset($_SESSION['number_event'])) { // มี seesion ที่มีจาก QR Code ไหม
                    echo "let number_event = " . $_SESSION['number_event'] . ";"; // ให้ number
                    echo "get_data_event_ajax(user_lat, user_lon, number_event);"; // call function js 
                } else {
