...
<div class="content">
    <div class="row">
        ...
        <div class="col">
            <button class="btn btn-info" style="margin-top: 2px; float:right; border-radius: 5px;"
                onclick="location.href='<?php echo base_url() . 'Admin/Manage_promotions/Admin_add_promotions/show_add_promotion' ?>'">เพิ่มโปรโมชัน</button>
        </div>
    </div>
            ...
            <div class="row">
                    ...
                    <div class="nav-tabs-navigation">
                        <div class="nav-tabs-wrapper">
                            <ul class="nav nav-tabs" data-tabs="tabs">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link"
                                        href="<?php echo base_url() . 'Admin/Manage_promotions/Admin_list_promotions/show_data_promo_over' ?> ">
                ...
                <div class="col">
                    <form class="form-inline custom-form-search "
                        action="<?php echo base_url() . 'Admin/Manage_company/Admin_approval_company/show_data_consider'; ?>"
                        method="POST">
    ...
    $(document).ready(function() {
        ...
        var success_edit = '<?php echo $this->session->userdata("error_edit_promotion_admin"); ?>';
        if (success_edit == 'success') {
            swal("แก้ไขโปรโมชันสำเร็จ", "แก้ไขโปรโมชันสำเร็จ", "success");
            <?php echo $this->session->unset_userdata("error_edit_promotion_admin"); ?>;
        }
        load_data(1);
