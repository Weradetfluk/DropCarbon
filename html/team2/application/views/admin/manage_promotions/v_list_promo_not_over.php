 <!-- 
/*
* v_list_promo_not_over
* table show list promotions approve and not over
* @input -
* @output table data promotions approve and not over
...
-->
                 ...
                 <div class="nav-tabs-navigation">
                     <div class="nav-tabs-wrapper">
                         <ul class="nav nav-tabs" data-tabs="tabs">
                             ...
                             <li class="nav-item">
                                 <a class="nav-link active" href="<?php echo base_url() . 'Admin/Manage_promotions/Admin_approval_promotions/show_data_pro_not_over'; ?>">
 ...
 <script>
     ...
     function load_data(page, query = '') {
         console.log(query);
         $.ajax({
             url: '<?php echo base_url('Admin/Manage_promotions/Admin_approval_promotions/get_promo_data_not_over_ajax/'); ?>' + 2,
             method: "POST",
             dataType: "Json",
             data: {
                 page: page,
