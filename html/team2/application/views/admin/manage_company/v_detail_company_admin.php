                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header" style="background-color: #8fbacb; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2)">
                            <center>
                                <h2 class="card-title text-white" style="font-family: 'Prompt', sans-serif !important;"><?php echo $arr_company->com_name; ?></h2>
                            </center>
                        </div>
                        <br>
                        <div class="card-body">
                            ...
                            <div class="container">
                                ...
                                <p style="font-size: 18px; text-indent: 50px;"><?php echo $arr_company->com_description; ?></p>
                            </div><br>
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-5">
                                        ...
                                        <hr width="100%" size="10" color="#cccccc">
                                        <p style="font-size: 18px; text-indent: 50px;">เบอร์โทรศัพท์: <?php echo $arr_company->com_tel; ?></p>
                                    </div>
                                </div>
                            </div><br><br>
                            ...
                            <?php if ($arr_company->com_status == 1) { ?>
                                <div class="container">
                                    <!-- Submit button -->
                                    <form>
                                        <input type="hidden" name="com_id" id="com_id" value="<?php echo $arr_company->com_id; ?>">
                                        <div style="text-align: right;">
                                            <button type="button" class="btn btn-success" id="accept" onclick='confirm_approve("<?php echo $arr_company->com_id ?>" ,"<?php echo $arr_company->com_name ?>", "<?php echo $arr_company->ent_email  ?>")' data-dismiss="modal">อนุมัติ</button>
                                            <button type="button" class="btn btn-danger" id="reject" onclick='confirm_reject("<?php echo $arr_company->com_id ?>", "<?php echo $arr_company->com_name ?>", "<?php echo $arr_company->ent_email  ?>")' data-dismiss="modal">ปฏิเสธ</button>
                                        </div>
                                    </form>
                                </div>
                            <?php } ?>
