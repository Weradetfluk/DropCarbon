                    ...
                    <div class="col-md-12">
                        <div class="card" style="border-radius: 25px;">
                            <div class="card-header" style="background-color: #60839f; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); border-radius: 10px;">
                                <div class="row">
                                    <div class="col py-2">
                                        <h4 class="card-title text-white custom-h4-card-table">ตารางแสดงข้อมูลสถานที่ที่ถูกปฏิเสธ</h4>
                                    </div>
                                    <div class="col">
                                        <form class="form-inline custom-form-search" action="#" method="POST" style="width: 200px; float:right;">
                                            ...
                                            if (sizeof($arr_company_reject) == 0) {
                                                ...
                                                for ($i = 0; $i < count($arr_company_reject); $i++) { ?>
                                                    <tr>
                                                        ...
                                                        <!-- column ดำเนินการ -->
                                                        <td style='text-align: center;'>
                                                            <a class="btn btn-info custom-btn-table" href="<?php echo base_url() . 'Admin/Manage_company/Admin_approval_company/show_detail_company/' . $arr_company_reject[$i]->com_id; ?>">
