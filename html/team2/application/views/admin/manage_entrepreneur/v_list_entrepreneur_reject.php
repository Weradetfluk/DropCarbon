                     ...
                     <div class="col-md-12">
                         <div class="card" style="border-radius: 25px;">
                             ...
                             <div class="row">
                                     ...
                                     <div class="col">
                                         <form class="form-inline" action="<?php echo base_url() . 'Admin/Manage_entrepreneur/Admin_approval_entrepreneur/show_data_reject'; ?>" method="POST" style="width: 200px; float:right;">
