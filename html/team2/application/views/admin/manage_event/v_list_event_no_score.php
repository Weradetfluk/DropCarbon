...
-->
                 ...
                 <div class="nav-tabs-navigation">
                     <div class="nav-tabs-wrapper">
                         <ul class="nav nav-tabs" data-tabs="tabs">
                             ...
                             <li class="nav-item">
                                 <a class="nav-link active" href=" <?php echo base_url() . 'Admin/Manage_event/Admin_approval_event/show_data_approve_no_score' ?> ">
 ...
 <script>
     ...
     function load_data(page, query = '') {
         console.log(query);
         $.ajax({
             url: '<?php echo base_url('Admin/Manage_event/Admin_approval_event/get_event_data_no_score_ajax/'); ?>' + 2,
             method: "POST",
             dataType: "Json",
             data: {
                 page: page,
     ...
     function create_table(data, pagation) 
     {
         ...
         data.forEach((row_eve, index_eve) => {
             ...
             html_code +='</i>';
             html_code += '</a>'
             html_code += '<button class="btn btn-success custom-btn-table" id="accept" onclick="confirm_add_score_eve(\'' + row_eve['eve_id'] + '\',\'' +  row_eve['eve_name'] +  '\',\'' + row_eve['ent_id'] +  '\')">';
             html_code += '<i class="material-icons">';
             html_code += 'add';
             html_code += '</i>'
             html_code += '</button>';
