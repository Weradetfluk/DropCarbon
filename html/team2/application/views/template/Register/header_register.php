...
<head>
    ...
    <link rel="icon" href="<?php echo base_url().'assets/templete/templatemo_559_zay_shop'?>/assets/img/brand/pic.jpg" type="image/png">
    <link rel="apple-touch-icon" href="<?php echo base_url().'assets/templete/templatemo_559_zay_shop'?>/assets/img/apple-icon.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url().'assets/templete/templatemo_559_zay_shop'?>/assets/img/favicon.ico">
