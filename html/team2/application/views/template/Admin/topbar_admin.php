...
<div class="wrapper ">
        ...
        <div class="container-fluid">
            ...
            <a href="#" class="navbar-brand">
                <img src="<?php echo base_url() . 'assets/templete/picture/./Logo-web.png' ?>"
                    style="max-width:400px; height: 50px; margin-top: -10px; margin-left: -40px;">
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-end">
                <ul class="navbar-nav nav-moblie-menu">
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="javascript:;" id="navbar_dropdown_profile" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbar_dropdown_profile">
                            <a class="dropdown-item"
                                href="<?php echo base_url() . 'Admin/Auth/Login_admin/logout' ?>">ออกจากระบบ</a>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <div class="sidebar" data-color="green"
        data-image="<?php echo base_url() . 'assets/templete/material-dashboard-master' ?>/assets/img/sidebar-1.jpg">
        <div class="sidebar-wrapper" style="margin-top: 70px;">
            <ul class="nav" id="active_menu">
                <li class="nav-item <?php if ($_SESSION['tab_number'] == 1) echo "active"; ?>">
                    <a class="nav-link <?php if ($_SESSION['tab_number'] == 1) echo "custom-a"; ?>"
                        href="<?php echo base_url() . 'Admin/Manage_dashboard/Admin_view_dashboard' ?>">
                        <i class="material-icons">dashboard</i>
                        <h5 class="h5-topbar">dashboard</h5>
                    </a>
                </li>
                <li class="nav-item <?php if ($_SESSION['tab_number'] == 2) echo "active custom-a"; ?>">
                    <a class="nav-link  <?php if ($_SESSION['tab_number'] == 2) echo "custom-a"; ?>"
                        href="<?php echo base_url() . 'Admin/Manage_banner/Admin_manage_banner' ?>">
                        <i class="material-icons">view_list</i>
                        <h5 class="h5-topbar">จัดการแบนเนอร์</h5>
                    </a>
                </li>
                <li class="nav-item  <?php if ($_SESSION['tab_number'] == 3) echo "active custom-a"; ?>" id="home">
                    <a class="nav-link  <?php if ($_SESSION['tab_number'] == 3) echo "custom-a"; ?>"
                        href="<?php echo base_url() . 'Admin/Manage_company/Admin_approval_company' ?>">
                ...
                <li class="nav-item event_menu">
                    <a class="nav-link" href="#" id="eve_menu">
                    ...
                    <ul class="event_sub_menu" id="eve_sub_menu">
                        <li class="nav-item  <?php if ($_SESSION['tab_number'] == 4) echo "active custom-a"; ?>">
                            <a class="nav-link  <?php if ($_SESSION['tab_number'] == 4) echo "custom-a"; ?>"
                                href="<?php echo base_url() . 'Admin/Manage_event/Admin_approval_event/show_data_consider' ?>">
                                <i class="material-icons">calendar_today</i>
                        ...
                        <li class="nav-item  <?php if ($_SESSION['tab_number'] == 8) echo "active custom-a"; ?>">
                            <a class="nav-link  <?php if ($_SESSION['tab_number'] == 8) echo "custom-a"; ?>"
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="#" id="pro_menu">
                    ...
                    <ul class="promo_sub_menu" id="pro_sub_menu">
                        <li class="nav-item  <?php if ($_SESSION['tab_number'] == 7) echo "active custom-a"; ?>">
                            <a class="nav-link  <?php if ($_SESSION['tab_number'] == 7) echo "custom-a"; ?>"
                                href="<?php echo base_url() . 'Admin/Manage_promotions/Admin_approval_promotions/show_data_consider' ?> ">
                                <i class="material-icons">point_of_sale</i>
                ...
                <li class="nav-item   <?php if ($_SESSION['tab_number'] == 5) echo "active custom-a"; ?>" id="ent_menu">
                    <a class="nav-link  <?php if ($_SESSION['tab_number'] == 5) echo "custom-a"; ?>"
                        href="<?php echo base_url() . 'Admin/Manage_entrepreneur/Admin_approval_entrepreneur' ?>">
                ...
                <li class="nav-item  <?php if ($_SESSION['tab_number'] == 6) echo "active custom-a"; ?>" id="tus_menu">
                    <a class="nav-link  <?php if ($_SESSION['tab_number'] == 6) echo "custom-a"; ?>"
                        href="<?php echo base_url() . 'Admin/Manage_tourist/Admin_list_tourist/show_data_tourist' ?> ">
