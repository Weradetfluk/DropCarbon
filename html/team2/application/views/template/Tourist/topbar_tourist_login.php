    ...
    <ul class="menu">
        ...
        <li class="item">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                ...
                <a class="dropdown-item" href="<?php echo base_url() . 'Tourist/Manage_tourist/Tourist_manage/show_reward_tourist' ?>"><span class="material-icons">card_giftcard</span> รางวัลของฉัน</a>
