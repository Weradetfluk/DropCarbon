        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2)">
                    ...
                    <div class="card-body">
                        <form
                            action="<?php echo base_url() . 'Entrepreneur/Manage_promotion/Promotion_add/add_promotion' ?>"
                            id="form_add_pro" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <textarea id="pro_description" name="pro_description" class="form-control"
                                        ...
                                        rows="5" placeholder="กรอกรายละเอียดของโปรโมชัน" required></textarea>
                                </div>
                            </div><br>
