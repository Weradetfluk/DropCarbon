        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2)">
                    ...
                    <div class="card-body">
                        <form
                            action="<?php echo base_url() . 'Entrepreneur/Manage_promotion/Promotion_edit/edit_promotion' ?>"
                            id="form_edit_pro" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" id="pro_name" name="pro_name" class="form-control"
                                        ...
                                        value="<?php echo $arr_promotion[0]->pro_name; ?>"
                                        onkeyup="check_pro_name_ajax()" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4" id="div-point">
                                    ...
                                    <input type="number" name="pro_point" id="pro_point" class="form-control"
                                        ...
                                        value="<?php echo $arr_promotion[0]->pro_point ?>" required>
                                </div>
                            </div><br>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <textarea id="pro_description" name="pro_description" class="form-control"
                                        style="border:solid 0.2px #B3B3E9; text-indent: 10px; padding: 0px 10px 0px 10px;"
                                        rows="5" placeholder="กรอกรายละเอียดของโปรโมชัน"
                                        required><?php echo $arr_promotion[0]->pro_description ?></textarea>
                                </div>
                            </div><br>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <input type="date" id="pro_start_date" name="pro_start_date" class="form-control"
                                        min="<?php echo $date_now ?>"
                                        value="<?php echo $arr_promotion[0]->pro_start_date ?>" required>
                                </div>
                                <div class="col-lg-2"></div>
                                <div class="col-lg-4">
                                    <label for="pro_end_date">วันที่เสร็จสิ้นโปรโมชัน</label>
                                    <input type="date" id="pro_end_date" name="pro_end_date" class="form-control"
                                        min="<?php echo $date_now ?>"
                                        value="<?php echo $arr_promotion[0]->pro_end_date ?>" required>
                                </div>
                            </div><br>

                            <!-- เลือกรูปภาพโปรโมชัน -->
                            <div class="form-group">
                                <label for="pro_file">รูปภาพประกอบโปรโมชัน <br><span
                                        style="color: red; font-size: 13px;">(ต้องมีรูปภาพอย่างน้อย 1 ภาพ
                                        และขนาดรูปไม่เกิน 3000 KB)</span></label>
                            </div>
                            <input class="d-none" type="file" id="pro_file" name="pro_file[]" accept="image/*"
                                onchange="upload_image_ajax()" multiple>
                            <button type="button" class="btn btn-info"
                                onclick="document.getElementById('pro_file').click();">เพิ่มรูปภาพ</button>
                            ...
                            <input type="hidden" name="pro_id" id="pro_id"
                                value="<?php echo $arr_promotion[0]->pro_id; ?>">
                            <!-- Submit button -->
                            <div style="text-align: right;">
                                <button type="button" id="btn_sub" class="btn btn-success"
                                    onclick="confirm_edit('<?php echo $arr_promotion[0]->pro_name ?>')">บันทึก</button>
