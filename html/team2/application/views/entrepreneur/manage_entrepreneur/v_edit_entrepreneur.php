    ...
    <div class="container py-5" style="background-color: white; border-radius: 25px; padding-right: 1.5%; padding-left: 1.5%;">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h1 class="h1" style="color:#990000; text-align: center; padding-top: 1%; padding-bottom: 1%; font-size: 250%">
                    แก้ไขข้อมูลผู้ประกอบการ </h1>
                <!-- <div class="card-header card-header-info">
                        <center style="font-weight: bold; font-size: 150%;">แก้ไขข้อมูลผู้ประกอบการ</center>
                    </div> -->
                <div class="card-body">
                    <b style="font-size: 30px; text-align: center; color:#1C1C1C">โปรดกรอกข้อมูลที่ต้องการแก้ไข</b><br><br>
                                ...
                                <form>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-2 mb-3">
                                            <label for="prefix" style="color:#000000; margin-bottom: 4px;">คำนำหน้า</label><br>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <label for="ent_id_card" style="font-size:12px; color:#FF0000">*ไม่สามารถแก้ไขหมายเลขบัตรประชาชนได้</label>
                                    ...
                                    <!-- แก้ไขรหัสผ่าน -->
                                    <b style="font-size: 30px; text-align: center; color:#1C1C1C">แก้ไขรหัสผ่าน</b><br><br>
                                    <div class="row">

                                        <!-- รหัสผ่าน -->
                                        <div class="col-6">
                                            <label for="ent_password" style="color:black">รหัสผ่าน</label>
                                            <input type="password" class="form-control" name='ent_password' value="<?php echo $arr_ent[0]->ent_password; ?>" required>
                                        </div>

                                        <!-- แก้ไขรหัสผ่าน -->
                                        <div class="col-6">
                                            <label for="ent_password" style="color:black">ยืนยันรหัสผ่าน</label>
                                            <input type="password" class="form-control" value="<?php echo $arr_ent[0]->ent_password; ?>" required>
                                        </div>
