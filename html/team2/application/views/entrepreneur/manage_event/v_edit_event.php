        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2)">
                    ...
                    <div class="card-body">
                        <form action="<?php echo site_url() . 'Entrepreneur/Manage_event/Event_edit/edit_event/' ?>" id="form_edit_eve" method="POST" enctype="multipart/form-data">
                                    ...
                                    <select name="eve_cat_id" class="form-control">
                                        <?php for ($i = 0; $i < count($arr_category); $i++) { ?>
                                            <?php if ($arr_category[$i]->eve_cat_id == $arr_event[0]->eve_cat_id) { ?>
                                                <option value="<?php echo $arr_category[$i]->eve_cat_id ?>" selected="selected"><?php echo $arr_category[$i]->eve_cat_name ?></option>
                                            <?php } ?>
                                            <?php if ($arr_category[$i]->eve_cat_id != $arr_event[0]->eve_cat_id) { ?>
                                                <option value="<?php echo $arr_category[$i]->eve_cat_id ?>"><?php echo $arr_category[$i]->eve_cat_name ?></option>
                                            <?php } ?>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    ...
                                    <input type="date" name="eve_start_date" value="<?php echo $arr_event[0]->eve_start_date; ?>" required>
                                </div>
                            </div><br>

                            <div class="form-group">
                                <label for="eve_end" style="color:black">วันที่เสร็จสิ้นกิจกรรม</label>
                                <input type="date" name="eve_end_date" value="<?php echo $arr_event[0]->eve_end_date; ?>" required>
                            </div><br>

                            <!-- เลือกรูปภาพประกอบกิจกรรม -->
                            <div class="form-group">
                                <label for="eve_file" style="color:black">รูปภาพประกอบสถานที่ <br><span style="color: red; font-size: 13px;">(ต้องมีรูปภาพอย่างน้อย 1 ภาพ
                            ...
                            <div style="text-align: right;">
                                ...
                                <a class="btn btn-secondary" style="color: white; background-color: #777777;" onclick="unlink_image_go_back()">ยกเลิก
                                </a>
                            </div>
                        </form>
                    </div>
