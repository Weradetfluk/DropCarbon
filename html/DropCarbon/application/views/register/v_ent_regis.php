...
<style>
    ...
    <div class="container py-5">
        ...
        <br>
        <form class="container py-5" method='POST' action='<?php echo site_url('register/Etp_input/insert_ent') ?>'>
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                <input type="password" class="form-control mt-1" id="pass" name="ent_password" placeholder="รหัสผ่าน" required>
            </div>

            <div class="form-group col-md-6 mb-3">
                <label for="password">ยืนยันรหัสผ่าน</label>
                <input type="password" class="form-control mt-1" id="confirm" name="cfp" placeholder="ยืนยันรหัสผ่าน" oninput="confirmpassword();" required><br>
                <div id="errorpassword" class="text-danger">

                </div>
            </div>
            </div>
            <button type="submit" id ="next" class="btn btn-success btn-lg px-3">ถัดไป</button>
